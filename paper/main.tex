...
\begin{center}
\parbox{\textwidth}{\setlength{\parindent}{1em}
{\centering\large\textbf{A Lightweight World Model Based on Multi-Input Multi-Output State Space Model for Humanoid Robots}} \vspace{-1.2mm}
...
\textbf{Citation:} X. Zhou, H. Yu, H. Zhang, et al. A lightweight world model based on multi-input multi-output state space model for humanoid robots. {\it Control Theory \& Applications}, xxxx, xx(x): xxx -- xxx}}
\end{center}
...
在机器人领域, Nagabandi等人\textsuperscript{\cite{15,16,17}}将神经网络动力学模型与模型预测控制相结合, 实现了机器人腿部运动的快速适应.
