...
在机器人领域, Nagabandi等人\textsuperscript{\cite{12,13,14}}将神经网络动力学模型与模型预测控制相结合, 实现了机器人腿部运动的快速适应.
...
S4通过结构化参数化解决了SSM在长程依赖建模中的数值稳定性问题.
...
在策略学习方面, Mamba策略网络在连续控制任务中取得了与Transformer策略网络相当的性能.
在时序预测方面, SSM被用于长程多变量时序预测.
在世界模型方面, Dreamer系列和TD-MPC等方法主要基于循环神经网络或潜在动力学模型,
面向视觉输入, 计算开销较大.
