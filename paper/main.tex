...
综合两个数据集上的实验结果, MIMO-WM在Humanoid上的精度优于各对比方法, MSE为0.199, 比Mamba-WM的0.202低1.5\%, 比Transformer-WM的0.281低29.3\%; 在HumanoidStandup上, MIMO-WM的MSE为0.531, $R^2$为0.444, 与Transformer精度相当, 但参数量仅0.138M, 为Transformer的45.7\%, 在所有方法中最为轻量.
